...
function init_gear_sets()
	...
	legs="Flamma Dirs +1",feet="Flam. Gambieras +1"}
	...
	sets.midcast['Enfeebling Magic'] = {ammo="Hasty Pinion +1",
		head="Carmine Mask +1",neck="Sanctity Necklace",ear1="Gwati Earring",ear2="Digni. Earring",
		body="Gorney Haubert +1",hands="Buremte Gloves",ring1="Mephitas's Ring +1",ring2="Stikini Ring",
		back="Niht Mantle",waist="Luminary Sash",legs="Flamma Dirs +1",feet="Flam. Gambieras +1"}
    ...
    sets.precast.WS = {ammo="Ginsen",
        ...
        body="Phorcys Korazin",hands="Flam. Manopolas +1",ring1="Rajas Ring",ring2="Spiral Ring",
        back="Buquwik Cape",waist="Fotia Belt",legs="Flamma Dirs +1",feet="Ejekamal Boots"}
    ...
    sets.idle.PDT = {ammo="Staunch Tathlum",
        ...
        back="Shadow Mantle",waist="Flume Belt",legs="Flamma Dirs +1",feet="Flam. Gambieras +1"}
	...
	sets.defense.PDT = {ammo="Staunch Tathlum",
        ...
        body="Acro Surcoat",hands="Buremte Gloves",ring1="Defending Ring",ring2="Dark Ring",
        back="Moonbeam Cape",waist="Flume Belt",legs="Flamma Dirs +1",feet="Flam. Gambieras +1"}
	...
	sets.defense.MDT = {ammo="Staunch Tathlum",
		head="Baghere Salade",neck="Loricate Torque +1",ear1="Sanare Earring",ear2="Ethereal Earring",
        body="Acro Surcoat",hands="Buremte Gloves",ring1="Defending Ring",ring2="Dark Ring",
        back="Engulfer Cape +1",waist="Flume Belt",legs="Flamma Dirs +1",feet="Flam. Gambieras +1"}
