...
function init_gear_sets()
    ...
    sets.precast.JA.Maneuver = {body="Cirque Farsetto +2",back="Dispersal Mantle"} --neck="Buffoon's Collar",hands="Foire Dastanas",
    ...
    sets.precast.WS = {
        ...
        back="Dispersal Mantle",waist="Grunfeld Rope",legs="Hiza. Hizayoroi +2",feet=gear.herculean_ta_feet}
	sets.precast.WS.Acc = {
        head="Lilitu Headpiece",neck="Fotia Gorget",ear1="Moonshade Earring",ear2="Telos Earring",
        body=gear.herculean_wsd_body,hands="Ryuo Tekko",ring1="Niqmaddu Ring",ring2="Regal Ring",
        back="Dispersal Mantle",waist="Grunfeld Rope",legs="Hiza. Hizayoroi +2",feet=gear.herculean_acc_feet}
	sets.precast.WS.FullAcc = {
        ...
        back="Dispersal Mantle",waist="Olseni Belt",legs="Hiza. Hizayoroi +2",feet=gear.herculean_acc_feet}
	sets.precast.WS.Fodder = {
        head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Brutal Earring",
        body=gear.herculean_wsd_body,hands="Ryuo Tekko",ring1="Niqmaddu Ring",ring2="Regal Ring",
        back="Buquwik Cape",waist="Grunfeld Rope",legs="Hiza. Hizayoroi +2",feet=gear.herculean_ta_feet}
    ...
    sets.midcast.Pet.WeaponSkill = {neck="Shulmanu Collar",ear1="Enmerkar Earring",ear2="Handler's Earring +1",body="Taeon Tabard",hands="Regimen Mittens",ring1="Varar Ring",ring2="Varar Ring",back="Dispersal Mantle",waist="Incarnation Sash",legs="Tali'ah Sera. +1"}
    ...
    sets.idle.Pet.Engaged = {
        ...
        back="Dispersal Mantle",waist="Hurch'lan Sash",legs="Tali'ah Sera. +1",feet="Hippo. Socks +1"}
	...
	sets.Weapons = {main="Denouements",range="Divinator",}
	sets.DDWeapons = {main="Godhands",range="Divinator",}
	sets.RangedWeapons = {main="Denouements",range="Divinator II",}
end
