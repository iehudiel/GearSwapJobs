...
function init_gear_sets()
	...
	sets.precast.WS = {ammo="Ginsen",
		...
		body="Adhemar Jacket",hands="Adhemar Wristbands",ring1="Niqmaddu Ring",ring2="Regal Ring",
	...
	sets.precast.WS["Victory Smite"].Acc = set_combine(sets.precast.WS["Victory Smite"], sets.precast.WSAcc, {head="Mummu Bonnet +1",ear1="Moonshade Earring",body="Mummu Jacket +1",hands="Ryuo Tekko",ring2="Begrudging Ring",legs="Mummu Kecks +1",feet="Mummu Gamash. +1"})
	...
	sets.engaged.SomeAcc = {ammo="Falcon Eye",
		head="Dampening Tam",neck="Moonbeam Nodowa",ear1="Brutal Earring",ear2="Sherida Earring",
		body="Mummu Jacket +1",hands="Adhemar Wristbands",ring1="Niqmaddu Ring",ring2="Epona's Ring",
		back="Segomo's Mantle",waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
	sets.engaged.Acc = {ammo="Falcon Eye",
		head="Dampening Tam",neck="Moonbeam Nodowa",ear1="Cessance Earring",ear2="Sherida Earring",
		body="Mummu Jacket +1",hands="Ryuo Tekko",ring1="Niqmaddu Ring",ring2="Ramuh Ring +1",
		back="Segomo's Mantle",waist="Olseni Belt",legs="Mummu Kecks +1",feet=gear.herculean_acc_feet}
