...
function init_gear_sets()
   ...
   sets.midcast.Pet.MagicReady = {ammo="Demonry Core",
    ...
    sets.engaged.DW = {main="Izizoeksi",sub="Hunahpu",ammo="Ginsen",
        ...
        body="Tartarus Platemail",hands="Meg. Gloves +2",ring1="Rajas Ring",ring2="Epona's Ring",
    ...
    sets.engaged.DW.SomeAcc = {ammo="Falcon Eye",
        ...
        body="Meg. Cuirie +2",hands="Leyline Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Windbuffet Belt +1",legs="Meg. Chausses +2",feet="Valorous Greaves"}
