...
function init_gear_sets()
    ...
    sets.precast.BloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Sancus Sachet +1",
        ...
        back="Conveyance Cape",waist="Kobo Obi",legs="Beck. Spats +1",feet="Baayami Sabots"}
    ...
    sets.precast.WS['Myrkr'] = {ammo="Sancus Sachet +1",
        ...
        body="Con. Doublet +3",hands="Asteria Mitts +1",ring1="Mephitas's Ring +1",ring2="Mephitas's Ring",
	...
	sets.midcast.Pet['Flaming Crush'] = {main="Espiritus",sub="Elan Strap +1",ammo="Sancus Sachet +1",
        head="Apogee Crown +1",neck="Adad Amulet",ear1="Gelos Earring",ear2="Lugalbanda Earring",
        body="Con. Doublet +3",hands=gear.merlinic_magpact_hands,ring1="Varar Ring",ring2="Varar Ring",
        back=gear.phys_jse_back,waist="Regal Belt",legs="Apogee Slacks +1",feet="Convo. Pigaches +3"}
	...
	sets.HPDown = {head="Apogee Crown +1",ear1="Mendicant's Earring",ear2="Evans Earring",
		...
		back="Swith Cape +1",legs="Apogee Slacks +1",feet="Herald's Gaiters"}
