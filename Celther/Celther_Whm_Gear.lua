...
function init_gear_sets()
	...
	sets.midcast.Cursna = {main=gear.grioavolr_nuke_staff,sub="Clemency Grip",ammo="Hasty Pinion +1",
		...
		back="Alaunus's Cape",waist="Witful Belt",legs="Th. Pantaloons +2",feet="Gende. Galosh. +1"}
	...
	sets.midcast.Stun.Resistant = {main=gear.grioavolr_nuke_staff,sub="Enki Strap",ammo="Pemphredo Tathlum",
	...
	sets.resting = {main="Chatoyant Staff",sub="Oneiros Grip",ammo="Homiliary",
		...
		body="Ebers Bliaud +1",hands=gear.chironic_refresh_hands,ring1="Defending Ring",ring2="Sheltered Ring",
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Homiliary",
		...
		body="Witching Robe",hands=gear.chironic_refresh_hands,ring1="Defending Ring",ring2="Sheltered Ring",
