...
function init_gear_sets()
    ...
    sets.precast.Waltz = {
        ...
        back="Mollusca Mantle",waist="Chaac Belt",legs="Dashing Subligar",feet=gear.herculean_waltz_feet}
    ...
    sets.midcast.FastRecast = {
        ...
        back="Mollusca Mantle",waist="Hurch'lan Sash",legs="Rawhide Trousers",feet=gear.herculean_dt_feet}
    ...
    sets.idle = {ammo="Staunch Tathlum",
        ...
        back="Solemnity Cape",waist="Flume Belt",legs=gear.herculean_dt_legs,feet="Fajin Boots"}
    ...
    -- Normal melee group
    sets.engaged = {
    main={ name="Skinflayer", augments={'"Triple Atk."+1','VIT+1','Accuracy+15','Attack+18','DMG:+13',}},
    ...
    back={ name="Canny Cape", augments={'DEX+1','AGI+2','"Dual Wield"+4',}},
}
		
    sets.engaged.SomeAcc = {ammo="Wingcutter +1",
        head="Dampening Tam",neck="Combatant's Torque",ear1="Suppanomimi",ear2="Sherida Earring",
    ...
    sets.engaged.Fodder = {ammo="Wingcutter +1",
    ...
    sets.engaged.Fodder2 = {ammo="Wingcutter +1",
    ...
    sets.engaged.PDT = {ammo="Staunch Tathlum",
        ...
        back="Mollusca Mantle",waist="Flume Belt",legs="Meg. Chausses +1",feet=gear.herculean_dt_feet}
