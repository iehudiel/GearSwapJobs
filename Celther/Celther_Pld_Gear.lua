...
function init_gear_sets()
    ...
    sets.Enmity = {ammo="Paeapua",
        ...
        back=gear.enmity_jse_back,waist="Creed Baudrier",legs="Cab. Breeches +1",feet="Eschite Greaves"}

    sets.Enmity.DT = {ammo="Staunch Tathlum",
        head="Loess Barbuta +1",neck="Unmoving Collar +1",ear1="Friomisi Earring",ear2="Trux Earring",
        body="Souveran Cuirass",hands="Macabre Gaunt. +1",ring1="Defending Ring",ring2="Dark Ring",
        back=gear.enmity_jse_back,waist="Creed Baudrier",legs="Cab. Breeches +1",feet="Eschite Greaves"}
    ...
    sets.precast.FC.DT = {ammo="Staunch Tathlum",
		...
		body="Odyss. Chestplate",hands="Leyline Gloves",ring1="Defending Ring",ring2="Dark Ring",
		back=gear.fastcast_jse_back,waist="Flume Belt",legs=gear.odyssean_fc_legs,feet="Odyssean Greaves"}
    ...
    sets.precast.WS['Atonement'] = {ammo="Paeapua",
		...
		body="Phorcys Korazin",hands=gear.odyssean_wsd_hands,ring1="Defending Ring",Ring2="Dark Ring",
	...
	sets.midcast.DTCast = {ammo="Staunch Tathlum",
		...
		back="Solemnity Cape",waist="Flume Belt",legs="Carmine Cuisses +1",feet="Odyssean Greaves"}
    ...
    sets.midcast.Reprisal = {ammo="Staunch Tathlum",
        ...
        body="Souveran Cuirass",hands="Souv. Handschuhs",ring1="Kunaji Ring",ring2="Meridian Ring",
        back="Xucau Mantle",waist="Creed Baudrier",legs="Souveran Diechlings",feet="Souveran Schuhs +1"}
	...
	sets.Self_Healing = {ammo="Staunch Tathlum",
		...
		body="Souveran Cuirass",hands="Macabre Gaunt. +1",ring1="Defending Ring",ring2="Meridian Ring",
		back="Solemnity Cape",waist="Creed Baudrier",legs="Souveran Diechlings",feet="Amm Greaves"}

	sets.Cure_Recieved = {body="Souveran Cuirass",legs="Souveran Diechlings",feet="Souveran Schuhs +1"}
	...
	sets.midcast.Phalanx = set_combine(sets.midcast['Enhancing Magic'], {hands="Souv. Handschuhs",back="Weard Mantle",feet="Souveran Schuhs +1"})
    ...
    sets.idle = {ammo="Homiliary",
		head="Jumalik Helm",neck="Coatl Gorget +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Jumalik Mail",hands="Souv. Handschuhs",ring1="Defending Ring",ring2="Sheltered Ring",
		back="Solemnity Cape",waist="Flume Belt",legs="Sulevi. Cuisses +1",feet="Hippo. Socks +1"}
	...
	sets.idle.Refresh = {ammo="Homiliary",
		head="Jumalik Helm",neck="Coatl Gorget +1",ear1="Etiolation Earring",ear2="Ethereal Earring",
		body="Jumalik Mail",hands="Souv. Handschuhs",ring1="Defending Ring",ring2="Karieyh Ring",
    ...
    sets.idle.Reraise = {ammo="Staunch Tathlum",
		...
		body="Twilight Mail",hands="Souv. Handschuhs",ring1="Defending Ring",ring2="Sheltered Ring",
		back="Solemnity Cape",waist="Flume Belt",legs="Carmine Cuisses +1",feet="Cab. Leggings +1"}
    ...
    sets.defense.PDT_HP = {ammo="Staunch Tathlum",
        ...
        body="Souveran Cuirass",hands="Souv. Handschuhs",ring1="Defending Ring",ring2="Meridian Ring",
        back="Xucau Mantle",waist="Creed Baudrier",legs="Chev. Cuisses +1",feet="Souveran Schuhs +1"}
    ...
    sets.defense.PDT_Reraise = {ammo="Staunch Tathlum",
		...
		back="Mollusca Mantle",waist="Flume Belt",legs="Chev. Cuisses +1",feet="Souveran Schuhs +1"}
	...
	sets.defense.BDT = {ammo="Staunch Tathlum",
		...
		back="Solemnity Cape",waist="Asklepian Belt",legs="Sulevi. Cuisses +1",feet="Amm Greaves"}
	...
	sets.engaged.NoShellTank = {ammo="Staunch Tathlum",
        ...
        back="Xucau Mantle",waist="Flume Belt",legs=gear.odyssean_fc_legs,feet="Cab. Leggings +1"}
