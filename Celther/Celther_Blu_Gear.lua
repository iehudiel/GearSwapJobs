...
function init_gear_sets()
	...
	sets.precast.Step = {ammo="Falcon Eye",
					...
					body="Adhemar Jacket",hands="Adhemar Wristbands",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	...
	sets.precast.Flourish1 = {ammo="Falcon Eye",
                   ...
                   body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Stikini Ring",ring2="Stikini Ring",
	...
	sets.precast.WS.HighAcc = sets.precast.WS.Acc
	...
	sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {ear1="Moonshade Earring",ear2="Brutal Earring",ring1="Rufescent Ring",legs=gear.herculean_wsd_legs})
	sets.precast.WS['Requiescat'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ear1="Moonshade Earring",ear2="Brutal Earring",hands="Adhemar Wristbands",ring1="Rufescent Ring",legs=gear.herculean_wsd_legs})
	...
	sets.precast.WS['Requiescat'].HighAcc = sets.precast.WS['Requiescat'].Acc
	...
	sets.precast.WS['Realmrazer'].HighAcc = sets.precast.WS['Realmrazer'].Acc
	...
	sets.precast.WS['Chant du Cygne'].HighAcc = sets.precast.WS['Chant du Cygne'].Acc
	...
	sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Karieyh Ring",legs=gear.herculean_wsd_legs,feet=gear.herculean_wsd_feet})
	sets.precast.WS['Savage Blade'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ear1="Moonshade Earring",ear2="Ishvara Earring",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Karieyh Ring",legs=gear.herculean_wsd_legs,feet=gear.herculean_wsd_feet})
	sets.precast.WS['Savage Blade'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",ear2="Telos Earring",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Karieyh Ring",legs="Carmine Cuisses +1"})
	...
	sets.precast.WS['Vorpal Blade'].HighAcc = sets.precast.WS['Vorpal Blade'].Acc
	...
	sets.precast.WS['Expiacion'] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",body="Assim. Jubbah +2",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Karieyh Ring",waist="Grunfeld Rope",legs=gear.herculean_wsd_legs,feet=gear.herculean_wsd_feet})
	sets.precast.WS['Expiacion'].SomeAcc = set_combine(sets.precast.WS.SomeAcc, {ear1="Moonshade Earring",ear2="Ishvara Earring",body="Assim. Jubbah +2",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Karieyh Ring",waist="Grunfeld Rope",legs=gear.herculean_wsd_legs,feet=gear.herculean_wsd_feet})
	sets.precast.WS['Expiacion'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",ear2="Telos Earring",body="Assim. Jubbah +2",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Karieyh Ring",legs="Carmine Cuisses +1"})
	sets.precast.WS['Expiacion'].HighAcc = sets.precast.WS['Expiacion'].Acc
	sets.precast.WS['Expiacion'].FullAcc = set_combine(sets.precast.WS.FullAcc, {body="Assim. Jubbah +2",hands="Jhakri Cuffs +1",ring1="Rufescent Ring"})
	...
	sets.precast.WS['Sanguine Blade'] = {ammo="Pemphredo Tathlum",
		             ...
		             body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Shiva Ring +1",ring2="Archon Ring",
	...
	sets.midcast['Blue Magic'].Physical.Resistant = {main="Tanmogayi +1",sub="Colada",ammo="Falcon Eye",
	    ...
	    body="Jhakri Robe +1",hands="Adhemar Wristbands",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	...
	sets.midcast['Blue Magic'].Physical.Fodder = {main="Iris",sub="Iris",ammo="Mavi Tathlum",
		...
		body="Assim. Jubbah +2",hands="Adhemar Wristbands",ring1="Apate Ring",ring2="Rajas Ring",
	...
	sets.midcast['Blue Magic'].PhysicalAcc = {main="Tanmogayi +1",sub="Colada",ammo="Falcon Eye",
		head="Jhakri Coronal +1",neck="Combatant's Torque",ear1="Zennaroi Earring",ear2="Telos Earring",
	    body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	    back=gear.da_jse_back,waist="Grunfeld Rope",legs="Jhakri Slops +1",feet=gear.herculean_acc_feet}
	...
	sets.midcast['Blue Magic'].Magical.Resistant = set_combine(sets.midcast['Blue Magic'].Magical,
		{neck="Sanctity Necklace",hands="Jhakri Cuffs +1",ring1="Stikini Ring",ring2="Stikini Ring",legs="Jhakri Slops +1",waist="Yamabuki-no-Obi"})
	...
	sets.midcast['Blue Magic'].MagicalMnd = set_combine(sets.midcast['Blue Magic'].Magical, {neck="Sanctity Necklace",hands="Jhakri Cuffs +1",ring1="Stikini Ring",ring2="Stikini Ring",legs="Jhakri Slops +1",waist="Yamabuki-no-Obi"})
	...
	sets.midcast['Blue Magic'].MagicAccuracy = {main="Iris",sub="Iris",ammo="Pemphredo Tathlum",
			        head="Jhakri Coronal +1",neck="Erra Pendant",ear1="Digni. Earring",ear2="Gwati Earring",
				    body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Stikini Ring",ring1="Stikini Ring",
	...
	sets.midcast['Blue Magic'].Healing = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Staunch Tathlum",
					head="Carmine Mask +1",neck="Incanter's Torque",ear1="Handler's Earring +1",ear2="Mendi. Earring",
			        body="Vrikodara Jupon",hands="Telchine Gloves",ring1="Sirona's Ring",ring2="Haoma's Ring",
			        back=gear.ElementalCape,waist=gear.ElementalObi,legs="Carmine Cuisses +1",feet="Medium's Sabots"}
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum",
			      head="Rawhide Mask",neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
			      body="Jhakri Robe +1",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Karieyh Ring",
	...
	sets.idle.Sphere = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum",
			      head="Rawhide Mask",neck="Loricate Torque +1",ear1="Etiolation Earring", ear2="Ethereal Earring",
			      body="Mekosu. Harness",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Karieyh Ring",
	...
	sets.idle.PDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Staunch Tathlum",
		        ...
		        body="Ayanmo Corazza +1",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Dark Ring",
	...
	sets.defense.PDT = {main="Terra's Staff",sub="Umbra Strap",ammo="Staunch Tathlum",
		        ...
		        body="Ayanmo Corazza +1",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Dark Ring",
				back="Mollusca Mantle",waist="Windbuffet Belt +1",legs=gear.herculean_dt_legs,feet=gear.herculean_dt_feet}
	...
	sets.Kiting = {back="Umbra Cape",legs="Carmine Cuisses +1"}
	...
	sets.Weapons = {main="Tizona", sub="Colada"}
	...
	sets.engaged.Acc = {ammo="Falcon Eye",
				...
				body="Adhemar Jacket",hands="Adhemar Wristbands",ring1="Epona's Ring",ring2="Petrov Ring",
				back=gear.da_jse_back,waist="Grunfeld Rope",legs="Adhemar Kecks",feet=gear.herculean_acc_feet}
				
	sets.engaged.Acc.AM = {ammo="Falcon Eye",
			    head="Dampening Tam",neck="Combatant's Torque",ear1="Digni. Earring",ear2="Telos Earring",
			    body="Adhemar Jacket",hands="Adhemar Wristbands",ring1="Epona's Ring",ring2="Ilabrat Ring",
			    back=gear.stp_jse_back,waist="Grunfeld Rope",legs="Adhemar Kecks",feet=gear.herculean_acc_feet}
				
	sets.engaged.HighAcc = {ammo="Falcon Eye",
				head="Carmine Mask +1",neck="Combatant's Torque",ear1="Suppanomimi",ear2="Telos Earring",
				body="Ayanmo Corazza +1",hands="Adhemar Wristbands",ring1="Ramuh Ring +1",ring2="Ilabrat Ring",
				back=gear.da_jse_back,waist="Olseni Belt",legs="Carmine Cuisses +1",feet=gear.herculean_acc_feet}
	...
	sets.engaged.FullAcc = {ammo="Falcon Eye",
				...
				body="Ayanmo Corazza +1",hands="Adhemar Wristbands",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
				back=gear.da_jse_back,waist="Olseni Belt",legs="Carmine Cuisses +1",feet=gear.herculean_acc_feet}
	...
	sets.engaged.DTLite = {ammo="Ginsen",
			    head="Dampening Tam",neck="Loricate Torque +1",ear1="Suppanomimi",ear2="Brutal Earring",
			    body="Ayanmo Corazza +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Patricius Ring",
	...
	sets.engaged.PDT = {ammo="Staunch Tathlum",
				head="Dampening Tam",neck="Loricate Torque +1",ear1="Suppanomimi",ear2="Brutal Earring",
		        body="Ayanmo Corazza +1",hands=gear.herculean_dt_hands,ring1="Defending Ring",ring2="Patricius Ring",
				back="Mollusca mantle",waist="Windbuffet Belt +1",legs=gear.herculean_dt_legs,feet=gear.herculean_ta_feet}
	...
	sets.engaged.SomeAcc.DTLite = {ammo="Ginsen",
			    head="Dampening Tam",neck="Loricate Torque +1",ear1="Suppanomimi",ear2="Telos Earring",
			    body="Ayanmo Corazza +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Patricius Ring",
			    back=gear.da_jse_back,waist="Grunfeld Rope",legs="Aya. Cosciales +1",feet=gear.herculean_ta_feet}
	...
	sets.engaged.Acc.PDT = {ammo="Falcon Eye",
				head="Dampening Tam",neck="Loricate Torque +1",ear1="Suppanomimi",ear2="Telos Earring",
				body="Ayanmo Corazza +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Patricius Ring",
				back="Mollusca mantle",waist="Flume Belt",legs="Aya. Cosciales +1",feet=gear.herculean_acc_feet}
	...
	sets.engaged.FullAcc.DTLite = {ammo="Falcon Eye",
			    head="Carmine Mask +1",neck="Loricate Torque +1",ear1="Suppanomimi",ear2="Telos Earring",
			    body="Ayanmo Corazza +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Patricius Ring",
			    back=gear.da_jse_back,waist="Olseni Belt",legs="Aya. Cosciales +1",feet=gear.herculean_ta_feet}
				
	sets.engaged.FullAcc.PDT = {ammo="Falcon Eye",
				head="Carmine Mask +1",neck="Loricate Torque +1",ear1="Zennaroi Earring",ear2="Telos Earring",
		        body="Ayanmo Corazza +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Patricius Ring",
				back=gear.da_jse_back,waist="Olseni Belt",legs="Carmine Cuisses +1",feet=gear.herculean_acc_feet}
