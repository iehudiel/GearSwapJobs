...
function init_gear_sets()
	...
	sets.precast.FC.BardSong = {main="Felibre's Dague",sub="Genmei Shield",range="Gjallarhorn",
	...
	sets.midcast.SongDebuff = {main="Legato Dagger",sub="Genmei Shield",range="Gjallarhorn",
