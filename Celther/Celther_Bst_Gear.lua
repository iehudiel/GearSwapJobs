...
function init_gear_sets()
	...
	-- CURING WALTZ
	sets.precast.Waltz = {
                head=gear.valorous_pet_head,neck="Loricate Torque +1",ear1="Handler's Earring",ear2="Handler's Earring +1",
                body="Tot. Jackcoat +1",hands="Regimen Mittens",ring1="Valseur's Ring",ring2="Asklepian Ring",
                back="Mollusca Mantle",waist="Chaac Belt",legs="Desultor Tassets",feet="Valorous Greaves"}
	...
	sets.midcast.Pet.MagicReady = set_combine(sets.midcast.Pet.WS, {head=gear.valorous_pet_head,legs="Valor. Hose",feet="Valorous Greaves"})
        ...
        sets.idle.Pet = {ammo="Demonry Core",
                head="Anwig Salade",neck="Empath Necklace",ear1="Handler's Earring",ear2="Handler's Earring +1",
    ...
    sets.engaged = {ammo="Ginsen",
        head=gear.valorous_acc_head,neck="Asperity Necklace",ear1="Brutal Earring",ear2="Sherida Earring",
    ...
    sets.engaged.SomeAcc = {ammo="Falcon Eye",
        head=gear.valorous_acc_head,neck="Defiant Collar",ear1="Brutal Earring",ear2="Sherida Earring",
	...
	sets.engaged.Acc = {ammo="Falcon Eye",
        head=gear.valorous_acc_head,neck="Combatant's Torque",ear1="Zennaroi Earring",ear2="Brutal Earring",
        body="Mes. Haubergeon",hands="Leyline Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Olseni Belt",legs="Acro Breeches",feet="Valorous Greaves"}
		
    sets.engaged.FullAcc = {ammo="Falcon Eye",
        head=gear.valorous_acc_head,neck="Combatant's Torque",ear1="Zennaroi Earring",ear2="Telos Earring",
        body="Mes. Haubergeon",hands="Leyline Gloves",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
        back="Ground. Mantle +1",waist="Olseni Belt",legs="Acro Breeches",feet="Valorous Greaves"}
		        
    sets.engaged.Fodder = {ammo="Ginsen",
        head=gear.valorous_acc_head,neck="Asperity Necklace",ear1="Trux Earring",ear2="Brutal Earring",
        body="Mes. Haubergeon",hands="Acro Gauntlets",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Bleating Mantle",waist="Windbuffet Belt +1",legs="Meg. Chausses +1",feet="Valorous Greaves"}
    ...
    sets.engaged.PDT = {ammo="Staunch Tathlum",
        ...
        back="Mollusca Mantle",waist="Flume Belt",legs="Meg. Chausses +1",feet="Valorous Greaves"}
	...
	sets.engaged.Acc.PDT = {ammo="Falcon Eye",
        head=gear.valorous_acc_head,neck="Loricate Torque +1",ear1="Brutal Earring",ear2="Sherida Earring",
        body="Jumalik Mail",hands="Buremte Gloves",ring1="Defending Ring",ring2="Dark Ring",
        back="Mollusca Mantle",waist="Flume Belt",legs="Meg. Chausses +1",feet="Valorous Greaves"}
    ...
    sets.engaged.DW = {ammo="Ginsen",
        head=gear.valorous_acc_head,neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Mes. Haubergeon",hands="Acro Gauntlets",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Bleating Mantle",waist="Windbuffet Belt +1",legs="Meg. Chausses +1",feet="Valorous Greaves"}
		
    sets.engaged.DW.SomeAcc = {ammo="Falcon Eye",
        head=gear.valorous_acc_head,neck="Defiant Collar",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Mes. Haubergeon",hands="Leyline Gloves",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Letalis Mantle",waist="Windbuffet Belt +1",legs="Meg. Chausses +1",feet="Valorous Greaves"}
